    ...
    <div>
      <div className="grid collection mt-[50px] gap-[30px]">
        {products.map((item) => {
          ...
          return (
            <div key={id}>
              <div className=" item border m-[20px] rounded-[15px] shadow lg:h-[560px]">
                <img
                  src={images[0]}
                  alt="wears"
                ...
                <div className="  m-[1rem] lg:m-[2rem]">
                  <p className=" font-bold text-[1rem] lg:text-[1.2rem]">
                    {" "}
                    {title}
                  </p>

                  <div className="font-bold lg:text-[1.1rem] text-700 text-[#374151] ">
                    Price: $ {price}
                  </div>
                </div>

                <div className="flex justify-end p-[10px] lg:p-[10px] ">
                  <button
